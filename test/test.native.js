...
var tanhf = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( tanhf instanceof Error )
};
...
tape( 'the function computes the hyperbolic tangent (large values)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var e;
...
tape( 'the function computes the hyperbolic tangent (small values)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var e;
...
tape( 'the function is an odd function (tanhf(-x) === -tanhf(x))', opts, function test( t ) {
	var values;
	var v;
	var i;
